...
const GenderFilter = ({ ...props }) => {
  return (
    <Style.Gender theme={props.theme}>
      <div className="male">
        <div
          className="ckeckbox"
          onClick={() =>
        ...
        <div className="icon-male">
          ...
          >
            <path
              ...
              fill={props.gender === 'male' ? `${props.theme.color}` : 'white'}
            />
          </svg>
        </div>
      </div>
      <div className="female">
        ...
        >
          {props.gender && props.gender === 'female' && (
            <div className="checked" />
          )}
        </div>
        <div className="icon-female">
          ...
          >
            <path
              ...
              fill={
                props.gender === 'female' ? `${props.theme.color}` : 'white'
              }
            />
          </svg>
        </div>
...
export default withTheme(GenderFilter);
